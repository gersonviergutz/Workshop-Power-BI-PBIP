---
name: dax
description: Skill para criação, revisão, documentação e otimização de medidas DAX em Power BI.
---

# Skill: DAX

## Quando usar
Use para criar ou revisar medidas, expressões DAX, KPIs, cálculos de tempo, metas, variações, ranking e medidas auxiliares.
